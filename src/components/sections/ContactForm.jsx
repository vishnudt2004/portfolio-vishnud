  ...
  return (
    <div className="group relative w-full">
      ...
      <Component
        id={id}
        className={twMerge(
          "focus-reset w-full rounded-xl border border-(--border-color-g)/25 bg-(--input-color) p-3 placeholder:tracking-wider focus:outline-2 focus:outline-offset-1 focus:outline-(--text-color-g) focus-visible:bg-(--bg-color-g)",
          className,
        )}
        {...props}
      />
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute top-0 right-0 m-2 p-2 group-focus-within:bg-(--bg-color-g)"
      >
